...
<head>
    ...
    <title>Early Childhood Program - Bright Future Academy</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/#academics">Academics</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        ...
                        <div class="bg-white bg-opacity-20 rounded px-3 py-2">
                            <strong>Levels:</strong> NUR, LKG, UKG
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-dark text-white py-4">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h6 class="fw-bold mb-2">Bright Future Academy</h6>
                    <p class="text-light opacity-75 small">Early Childhood Program - Building strong foundations for lifelong learning</p>
                </div>
